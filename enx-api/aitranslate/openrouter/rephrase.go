...
// Rephrase implements rephrase.Rephraser against OpenRouter's OpenAI-compatible
...
func (o *OpenRouter) Rephrase(ctx context.Context, input string) (rephrase.Result, error) {
	content, u, err := o.chat(ctx, "rephrase_to_english", o.modelForRephrase(), rephrase.Temperature, rephrase.SystemPrompt, input)
	if err != nil {
