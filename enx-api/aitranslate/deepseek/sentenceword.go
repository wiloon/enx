...
// call (ADR-014): one DeepSeek request returns both the whole-sentence
...
func (d *DeepSeek) TranslateSentenceWithWord(ctx context.Context, sentence, word string) (sentenceword.Result, aiusage.Usage, error) {
