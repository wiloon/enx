...
// call (ADR-014): one Kimi request returns both the whole-sentence
...
func (k *Kimi) TranslateSentenceWithWord(ctx context.Context, sentence, word string) (sentenceword.Result, aiusage.Usage, error) {
