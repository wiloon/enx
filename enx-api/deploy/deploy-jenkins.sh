...
ansible -i '192.168.50.36,' all -m copy -a 'src=/var/lib/jenkins/workspace/enx-api/deploy/enx-api.service dest=/etc/systemd/system/enx-api.service' -u root --key-file ~/.ssh/id_ed25519
